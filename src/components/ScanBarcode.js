            ...
            <View style={styles.container}>
                ...
                <RNCamera
                    ...
                    androidCameraPermissionOptions={{
                        title: 'Autorisation d\'utiliser un appareil photo',
                        message: 'Nous avons besoin de votre autorisation pour utiliser votre appareil photo',
                        buttonPositive: 'Ok',
                        buttonNegative: 'Annuler',
                    }}
                    androidRecordAudioPermissionOptions={{
                        title: 'Autorisation d\'utiliser un enregistrement audio',
                        message: 'Nous avons besoin de votre autorisation pour utiliser votre audio',
                        buttonPositive: 'Ok',
                        buttonNegative: 'Annuler',
                    }}
    ...
    async onBarCodeRead(event) {
        ...
        if (event.data === this.state.token_storate) {
            ...
            fetch(url + 'wp-json/meup/v1/validate_ticket/',
                ...
                .catch((error) => {
                    alert('erreur, veuillez re scanner');
                });
